...
export function page1Intro(f: ContractFields) {
  return [
    ...
    {
      text: `2. Rivenditore, una società o impresa [[B]]${f.companyName}[[B]] costituita e operante secondo le Leggi della Repubblica Italiana, numero Registro Imprese [[B]]${f.vatNumber}[[B]] con sede in [[B]]${f.address}[[B]], numero di telefono [[B]]${f.mobileNumber}[[B]], persona di contatto ${f.contactPerson}.`,
    },
  ]
}
